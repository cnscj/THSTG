...
namespace XLibrary.Lang
{
    public class LRUCache<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public LRUCache(IEnumerable<KeyValuePair<TKey, TValue>> source)
        {
            if (source == null)
            {
        ...
        public LRUCache(IEnumerable<KeyValuePair<TKey, TValue>> source, IEqualityComparer<TKey> comparer)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source");
