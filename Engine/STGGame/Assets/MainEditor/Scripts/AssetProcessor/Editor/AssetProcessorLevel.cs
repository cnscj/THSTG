...
namespace STGEditor
{
    public class AssetProcessorLevel : ResourceProcesser
    {
        public AssetProcessorLevel(string md5Folder, string exportFolder) : base(md5Folder, exportFolder)
        {
        }
        ...
        protected override List<string> OnFilter()
        {
            ...
            string[] guids = AssetDatabase.FindAssets("t:Scene", new string[1] { AssetProcessorConfig.srcLevels });
