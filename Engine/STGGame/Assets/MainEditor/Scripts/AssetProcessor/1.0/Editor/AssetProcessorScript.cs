...
namespace STGEditor
{
    public class AssetProcessorScript : ResourceProcesser
    {
        public AssetProcessorScript(string md5Folder, string exportFolder) : base(md5Folder, exportFolder)
        {
        ...
        protected override List<string> OnFilter()
        {
            ...
            XFolderTools.TraverseFiles(AssetProcessorConfig.srcScripts, (fullPath) =>
             {
                 //值拷贝png和bytes文件
