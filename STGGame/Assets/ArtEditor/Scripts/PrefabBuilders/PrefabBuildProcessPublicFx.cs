...
namespace STGEditor
{
    public class PrefabBuildProcessPublicFx : PostProcesser
    {
        public PrefabBuildProcessPublicFx(string md5Folder, string exportFolder) : base(md5Folder, exportFolder)
        {
