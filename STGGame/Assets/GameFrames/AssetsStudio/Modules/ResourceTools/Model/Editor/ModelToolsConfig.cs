...
namespace ASEditor
{
    public class ModelToolsConfig : BaseResourceConfig<ModelToolsConfig>
    {
        static string assetPath = ChangeAssetPath(string.Format("Assets/Resources/ASModelToolsConfig.asset"));
